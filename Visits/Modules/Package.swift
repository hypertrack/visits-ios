...
let package = Package(
  ...
  targets: [
    ...
    // Screen
    .target(name: "AppScreen",                       dependencies: [architecture, "BlockerScreen", "DeepLinkScreen", "DeviceID", "DriverID", "DriverIDScreen", "History", "LoadingScreen", "MapScreen", "ProfileScreen", "SignInScreen", "SummaryScreen", "TabSelection", "Views", "VisitScreen", "VisitsScreen"]),
    ...
    .target(name: "SignInScreen",                    dependencies: [architecture, "Views"]),
    ...
    // Environment
    .target(name: "APIEnvironment",                  dependencies: [architecture, "Coordinate", "Credentials", "DeviceID", "History", nonEmpty, "Prelude", "PublishableKey", "Tagged", "Visit"]),
    ...
    .target(name: "PasteboardEnvironment",           dependencies: [architecture, nonEmpty]),
    ...
    .target(name: "AppAdapter",                      dependencies: ["AppLogic", "AppScreen", architecture, "Coordinate", "DeepLinkScreen", "MapScreen", "Prelude", "PushStatus", "Visit"]),
    // Tests
