...
public struct OperationalState: Equatable {
  public var alert: Either<AlertState<ErrorAlertAction>, AlertState<SendErrorReportAction>>?
  ...
  public init(alert: Either<AlertState<ErrorAlertAction>, AlertState<SendErrorReportAction>>? = nil, experience: Experience, flow: AppFlow, locationAlways: LocationAlwaysPermissions, pushStatus: PushStatus, sdk: SDKStatusUpdate, version: AppVersion, visibility: AppVisibility) {
